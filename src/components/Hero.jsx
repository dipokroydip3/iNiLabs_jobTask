...
const Hero = () => {
      return (
            <div className=" w-10/12 lg:h-[469px] m-auto lg:flex py-10">
                  <div className="lg:pr-24">
                        <div>
                              <h1 className="font-bold text-3xl lg:text-5xl text-[#050038]">Take ideas from  better to best</h1>
                              ...
                              <div className="bg-gray-300 my-8 px-5 rounded py-3 lg:inline-flex gap-10">
                                    <div>
                  ...
                  <div>
                        <img className="mb-3 w-auto shadow-md" src="https://i.ibb.co/YtXmymb/dashboard-design.png" alt="" />
