...
const Teams = () => {
      return (
            <div className="w-10/12 m-auto py-10 ">
                  ...
                  <ul className="flex flex-wrap gap-10 items-center text-lg py-5">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-10">
                        <div className=" lg:col-span-1 text-gray-400 space-y-5 mt-6">
                        ...
                        <div className=" lg:col-span-3">
                              <img className=" " src="https://i.ibb.co/XCXK1QG/1ea64d58add959141ee969b84cacf29d.png" alt="" />
                        </div>
                  </div>
            </div>
      );
